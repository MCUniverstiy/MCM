...
<section class="hero-home" aria-labelledby="home-title">
  <div class="container hero-home-inner">
    <div class="hero-home-content">
      ...
      <p class="reveal reveal-delay-2" data-i18n="home.hero.body">MCM Wealth Management Limited is a single family office investing its own capital. We serve one family only and help connect independent SFO peers for community and perspective exchange.</p>
      <div class="btn-group reveal reveal-delay-3">
        <a href="<?php echo esc_url( home_url( '/investment-approach/' ) ); ?>" class="btn btn-primary" data-i18n="home.hero.cta1">Explore our approach</a>
        <a href="<?php echo esc_url( home_url( '/perspectives/' ) ); ?>" class="btn btn-ghost-dark" data-i18n="home.hero.cta2">Explore perspectives</a>
      </div>
    </div>
...
<section class="section--white" aria-labelledby="identity-title">
  <div class="container identity-grid">
    <div class="identity-copy reveal">
      <span class="eyebrow" data-i18n="home.identity.eyebrow">Who we are</span>
      <h2 id="identity-title">One family mandate.<br>A bridge between peers.</h2>
      <p>MCM exists solely to steward and invest its own family capital. We do not manage wealth or provide advisory services for other families.</p>
      <p>Our outward role is community-minded: we help connect single family offices so peers can meet, exchange perspectives, and learn from one another while retaining their independence.</p>
    </div>
    <aside class="clarity-card reveal reveal-delay-1">
      <span class="eyebrow">Our boundary</span>
      <h3>Community, not client service</h3>
      <ul class="clarity-list">
        <li>We serve one family only.</li>
        <li>We do not market services, packages, or advice.</li>
        <li>Peer introductions do not create advisory or investment relationships.</li>
        <li>Each family office remains responsible for its own decisions.</li>
      </ul>
    </aside>
  </div>
</section>
...
<section class="section--white" aria-labelledby="focus-title">
  <div class="container">
    ...
    <div class="focus-grid">
      <a class="focus-card reveal" href="<?php echo esc_url( home_url( '/family-office/' ) ); ?>"><span class="number">01</span><span class="arrow" aria-hidden="true">↗</span><h3 data-i18n="focus.1.title">Family Office Stewardship</h3><p data-i18n="focus.1.short">Coordinating our own family affairs, governance, and capital with a multi-generational view.</p></a>
      <a class="focus-card reveal reveal-delay-1" href="<?php echo esc_url( home_url( '/wealth-coordination/' ) ); ?>"><span class="number">02</span><span class="arrow" aria-hidden="true">↗</span><h3 data-i18n="focus.2.title">Capital Allocation</h3><p data-i18n="focus.2.short">Considering opportunities in the context of portfolio fit, risk, liquidity, and time horizon.</p></a>
      <a class="focus-card reveal" href="<?php echo esc_url( home_url( '/estate-legacy/' ) ); ?>"><span class="number">03</span><span class="arrow" aria-hidden="true">↗</span><h3 data-i18n="focus.3.title">Legacy &amp; Continuity</h3><p data-i18n="focus.3.short">Supporting continuity of values, knowledge, and thoughtful decision-making across generations.</p></a>
      <a class="focus-card reveal reveal-delay-1" href="<?php echo esc_url( home_url( '/business-succession/' ) ); ?>"><span class="number">04</span><span class="arrow" aria-hidden="true">↗</span><h3 data-i18n="focus.4.title">Enterprise Perspective</h3><p data-i18n="focus.4.short">Taking a patient view of durable businesses, private opportunities, and responsible value creation.</p></a>
      <a class="focus-card reveal" href="<?php echo esc_url( home_url( '/tax-strategy/' ) ); ?>"><span class="number">05</span><span class="arrow" aria-hidden="true">↗</span><h3 data-i18n="focus.5.title">Specialist Coordination</h3><p data-i18n="focus.5.short">Engaging independent legal, tax, and investment expertise for our own family needs when appropriate.</p></a>
      <a class="focus-card focus-card--accent reveal reveal-delay-1" href="<?php echo esc_url( home_url( '/perspectives/' ) ); ?>"><span class="number">06</span><span class="arrow" aria-hidden="true">↗</span><h3 data-i18n="home.focus.6.title">SFO community</h3><p data-i18n="home.focus.6.body">We help connect independent single family offices for relevant, non-commercial peer exchange.</p></a>
    </div>
  </div>
</section>

<section class="cta-band" aria-labelledby="home-cta-title"><div class="container cta-band-content reveal"><span class="eyebrow" data-i18n="cta.opportunity.eyebrow">Open to peer exchange</span><h2 id="home-cta-title" data-i18n="cta.opportunity.title">Part of the SFO community?</h2><p data-i18n="cta.opportunity.body">We welcome a concise introduction from independent single family offices interested in relevant peer connection and perspective exchange.</p><div class="btn-group"><a href="<?php echo esc_url( home_url( '/perspectives/' ) ); ?>" class="btn btn-primary" data-i18n="cta.opportunity.primary">Explore perspectives</a><a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>" class="btn btn-secondary" data-i18n="cta.opportunity.secondary">Contact MCM</a></div></div></section>
